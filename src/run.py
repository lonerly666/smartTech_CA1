...
(x_train, y_train, train_crop), (x_val, y_val, val_crop), x_test, labels_indexes, labels_english = extract_data()
...
with open('./predictions.txt', 'w') as f:
    ...
    translated_predictions = translate_predictions(predictions, labels_indexes, labels_english)
